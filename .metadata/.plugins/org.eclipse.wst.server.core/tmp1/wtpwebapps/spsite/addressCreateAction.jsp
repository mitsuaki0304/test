	...
	<table>
			<s:form action="AddressCreateConfirmAction">
				...
				<tr>
					...
					<td><input type="text" name="userAddressNum" value="" /></td>
				</tr>
				<tr>
					<td><label>都道府県:</label></td>
					<td><select name="userAddressPrefecture">
...
<option value="沖縄県">沖縄県</option>
				...
				<tr>
					...
					<td><input type="text" name="userAddressCity" value="" /></td>
				</tr>
				<tr>
					<td><label>建物等:</label></td>
					<td><input type="text" name="userAddressOther" value="" /></td>
				</tr>
				<s:submit value="登録" />
			</s:form>
		</table>
