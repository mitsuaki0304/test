	...
	<div id="main">
		...
		<s:form action="BuyItemCompleteAction">
			<table>
				...
				<!-- 					onclick="submitAction('BuyItemCompleteAction')" /></td> -->
				<!-- 			</tr> -->
				<tr>


					<s:hidden name="userAddressPrefecture"
						value="%{#session.userAddressPrefecture}" />

					<s:hidden name="userAddressCity"
						value="%{#session.userAddressCity}" />

					<s:hidden name="userAddressOther"
						value="%{#session.userAddressOther}" />
